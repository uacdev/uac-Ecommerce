...
import { Instagram, MessageCircle, Menu, X, Sun, Moon, ShoppingBag, Search, ChevronRight, ChevronDown, LayoutGrid, Sofa, Zap, Sparkles, Cpu, ShoppingBasket, Heart } from 'lucide-react'
...
const Navbar = () => {
    ...
    const categories = [
        { name: 'Shop All',   icon: LayoutGrid,     desc: 'Browse everything',        filter: 'All' },
        { name: 'Furniture',  icon: Sofa,            desc: 'Sofas, tables, beds & more', filter: 'Furniture' },
        { name: 'Appliances', icon: Zap,             desc: 'Kitchen & home appliances', filter: 'Appliances' },
        { name: 'Gadgets',    icon: Cpu,             desc: 'Electronics & tech items', filter: 'Gadgets' },
        { name: 'Decor',      icon: Sparkles,        desc: 'Art, rugs, lamps & more',  filter: 'Decor' },
    ]
        ...
        <nav className="fixed top-0 left-0 w-full z-50 md:px-6 md:py-4">
            <div className="max-w-7xl mx-auto flex justify-between items-center glass px-4 py-3 md:px-8 md:py-4 transition-all duration-500 rounded-none md:rounded-[32px] border-none shadow-2xl" style={{ backgroundColor: 'var(--nav-bg)' }}>
                ...
                <div className="hidden lg:flex items-center gap-10">
                    ...
                    <a href="#all-products" className="text-[10px] font-black uppercase tracking-[0.25em] hover:text-[#F18B24] transition-colors relative group" style={{ color: 'var(--text-primary)' }}>
                        New Arrivals
                ...
                <div className="hidden md:flex items-center gap-3 lg:gap-5">
                    ...
                    <a href="#all-products" className="btn-primary py-3.5 px-8 text-[10px] uppercase tracking-widest font-black rounded-2xl shadow-lg shadow-[#F18B2420]">
                        Shop Store
                    </a>
                </div>
            ...
            <AnimatePresence>
                {searchOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -20 }}
                        className="absolute top-full left-6 right-6 mt-4 z-40"
                    >
