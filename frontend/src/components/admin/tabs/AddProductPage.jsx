...
const AddProductPage = ({ product, onClose }) => {
    const { addProduct, updateProduct, businessSegments } = useStore();
        ...
        >
            <div className="max-w-5xl mx-auto py-2">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    {error && (
                        <div className="px-4 py-3 rounded-xl bg-red-50 dark:bg-red-950/30 text-[#ed0000] text-[12px] font-bold">
                            {error}
                        </div>
                    )}
