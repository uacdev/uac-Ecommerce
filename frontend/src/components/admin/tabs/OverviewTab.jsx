            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-7 xl:col-span-8 space-y-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <KpiCard title="Returning rate" value="68%" trend="+2.4%" isPositive />
                        <KpiCard title="Abandonment rate" value="23.8%" trend="-1.8%" isPositive={false} />
                        <KpiCard title="Daily visitors" value="12,450" trend="+15.3%" isPositive />
                    </div>
                ...
                <div className="lg:col-span-5 xl:col-span-4 space-y-8">
                                    ...
                                    <div key={p.id} className="flex items-center justify-between group cursor-pointer">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] text-[var(--text-muted)] font-bold mt-0.5">₦{p.price.toLocaleString()}</p>
                                            </div>
                                        </div>
                    ...
                    <div className="bg-[var(--bg-tertiary)] rounded-2xl border border-[var(--divider)] shadow-sm p-6">
                        ...
                        <div className="space-y-5">
                            <InsightRow label="New users" value="15" icon={<Users size={14} />} color="bg-red-50 text-[#ed0000]" />
                            <InsightRow label="Active users" value="2,847" icon={<Users size={14} />} color="bg-[var(--bg-secondary)] text-[var(--text-muted)]" />
                            <InsightRow label="Retention" value="68%" icon={<TrendingUp size={14} />} color="bg-emerald-50 text-emerald-600" />
                        </div>
                        <div className="mt-8 pt-8 border-t border-[var(--divider)]">
                            ...
                            <div className="space-y-3">
                                <CustomerRow name="Alice Johnson" img="https://ui-avatars.com/api/?name=Alice&background=ed0000&color=fff" spend="₦24,500" />
                                <CustomerRow name="Robert Smith" img="https://ui-avatars.com/api/?name=Robert&background=000&color=fff" spend="₦18,200" />
                            </div>
                        </div>
                    </div>
                </div>
