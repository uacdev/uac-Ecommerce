                        ...
                        <div className="p-8 md:p-10 rounded-[32px] border bg-[var(--bg-secondary)]" style={{ borderColor: 'var(--divider)' }}>
                            ...
                            <div className="space-y-4">
                                <button
                                    ...
                                    style={{
                                        borderColor: paymentMethod === 'monnify' ? 'var(--brand-red)' : 'transparent',
                                        background: paymentMethod === 'monnify' ? 'var(--badge-bg)' : 'var(--bg-primary)'
                                    }}
                                >
                                    <div className="flex items-center gap-4">
                                        <div className={`w-5 h-5 rounded-full border-4 ${paymentMethod === 'monnify' ? 'border-[var(--brand-red)]' : 'border-[var(--divider)]'}`} />
                                        <div className="text-left">
                                            <p className="font-black text-sm uppercase tracking-widest" style={{ color: 'var(--text-primary)' }}>Monnify Checkout</p>
                                            <p className="text-[10px] font-bold text-[var(--text-muted)]">Card, Transfer, Instant Confirmation</p>
                                        </div>
                                    </div>
                                    <img src="https://monnify.com/wp-content/uploads/2021/04/monnify-logo.png" alt="Monnify" className="h-4 opacity-50 grayscale" />
                                </button>
                                ...
                                <button
                                    ...
                                    className="w-full p-6 rounded-2xl flex justify-between items-center transition-all border-2"
                                    style={{
                                        borderColor: paymentMethod === 'opay' ? 'var(--brand-red)' : 'transparent',
                                        background: paymentMethod === 'opay' ? 'var(--badge-bg)' : 'var(--bg-primary)'
                                    }}
                                >
                                    <div className="flex items-center gap-4">
                                        <div className={`w-5 h-5 rounded-full border-4 ${paymentMethod === 'opay' ? 'border-[var(--brand-red)]' : 'border-[var(--divider)]'}`} />
                                        <div className="text-left">
                                            <p className="font-black text-sm uppercase tracking-widest" style={{ color: 'var(--text-primary)' }}>OPay Wallet</p>
                                            <p className="text-[10px] font-bold text-[var(--text-muted)]">Pay via OPay App / Mobile Number</p>
                                        </div>
                                    </div>
                                    <div className="w-10 h-10 rounded-full bg-emerald-500/10 flex items-center justify-center font-black text-emerald-500 text-[10px]">OPay</div>
                                </button>

                                <button
                                    type="button"
                                    onClick={() => setPaymentMethod('bank')}
                                    className="w-full p-6 rounded-2xl flex justify-between items-center transition-all border-2 opacity-60"
                                    style={{
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="text-left">
                                            ...
                                            <p className="text-[10px] font-bold text-red-400">Manual Confirmation Required (UFL Desk)</p>
                                        </div>
                                    </div>
                                </button>
                            </div>
