    ...
    return (
        ...
        >
            <div className="text-center mb-12">
                ...
                {orderId && <p className="text-[var(--brand-red)] text-sm font-mono mt-2">Order: {orderId}</p>}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                ...
                >
                    ...
                    <ul className="space-y-3 text-sm" style={{ color: 'var(--text-secondary)' }}>
                        ...
                        <li className="flex items-center gap-2"><Clock size={14} className="text-[var(--brand-red)]" /> 2-3 day delivery window</li>
